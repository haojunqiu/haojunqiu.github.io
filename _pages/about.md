...
In Summer 2024, I worked with [Prof. Jiajun Wu](https://jiajunwu.com) and [Prof. Elliott Wu](https://elliottwu.com) on video score distillation and motion modeling. In Summer 2025, I participated in the [Summer Geometry Initiative (SGI)]((https://sgi.mit.edu)) at MIT, where I explored some topics in geometry processing (Monte Carlo geometry processing, logarithmic heat diffusion, and fluid simulation with gaussian velocity field).
